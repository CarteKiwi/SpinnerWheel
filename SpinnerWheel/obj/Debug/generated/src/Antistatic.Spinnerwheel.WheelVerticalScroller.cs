...
namespace Antistatic.Spinnerwheel {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='antistatic.spinnerwheel']/class[@name='WheelVerticalScroller']"
	[global::Android.Runtime.Register ("antistatic/spinnerwheel/WheelVerticalScroller", DoNotGenerateAcw=true)]
	public partial class WheelVerticalScroller : global::Antistatic.Spinnerwheel.WheelScroller {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("antistatic/spinnerwheel/WheelVerticalScroller", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WheelVerticalScroller); }
		}

		protected WheelVerticalScroller (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Lantistatic_spinnerwheel_WheelScroller_ScrollingListener_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='antistatic.spinnerwheel']/class[@name='WheelVerticalScroller']/constructor[@name='WheelVerticalScroller' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='antistatic.spinnerwheel.WheelScroller.ScrollingListener']]"
		[Register (".ctor", "(Landroid/content/Context;Lantistatic/spinnerwheel/WheelScroller$ScrollingListener;)V", "")]
		public unsafe WheelVerticalScroller (global::Android.Content.Context p0, global::Antistatic.Spinnerwheel.WheelScroller.IScrollingListener p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (WheelVerticalScroller)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Antistatic.Spinnerwheel.WheelVerticalScroller __this = global::Java.Lang.Object.GetObject<global::Antistatic.Spinnerwheel.WheelVerticalScroller> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		protected override unsafe int CurrentScrollerPosition {
			// Metadata.xml XPath method reference: path="/api/package[@name='antistatic.spinnerwheel']/class[@name='WheelVerticalScroller']/method[@name='getCurrentScrollerPosition' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected override unsafe int FinalScrollerPosition {
			// Metadata.xml XPath method reference: path="/api/package[@name='antistatic.spinnerwheel']/class[@name='WheelVerticalScroller']/method[@name='getFinalScrollerPosition' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='antistatic.spinnerwheel']/class[@name='WheelVerticalScroller']/method[@name='getMotionEventPosition' and count(parameter)=1 and parameter[1][@type='android.view.MotionEvent']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='antistatic.spinnerwheel']/class[@name='WheelVerticalScroller']/method[@name='scrollerFling' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='antistatic.spinnerwheel']/class[@name='WheelVerticalScroller']/method[@name='scrollerStartScroll' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
